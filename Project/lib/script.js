...
function level3() {
  ...
  document.getElementById('popul').innerHTML = population;
  document.getElementById('info').innerHTML =
    'Размер популяции должен быть равен 324 к 10 поколению';
  drawField();
}
function check3level() {
  count_population();
  
  if (count == 10 && population == 324) {
    stopLife();
    document.getElementById('info').innerHTML = 'You score';
  } else if (count > 10 && population != 324) {
    stopLife();
    document.getElementById('info').innerHTML = 'Didn’t work, Try again';
  }
}
...
function check5level() {
  ...
  if (count == 5 && population == 46) {
    stopLife();
    document.getElementById('info').innerHTML = 'You score';
  } else if (count > 5 && population != 46) {
    stopLife();
    document.getElementById('info').innerHTML = 'Didn’t work, Try again';
  }
}
...
function check6level() {
  ...
  if (count == 20 && population == 304) {
    stopLife();
    document.getElementById('info').innerHTML = 'You score';
  } else if (count > 20 && population != 304) {
    stopLife();
    document.getElementById('info').innerHTML = 'Didn’t work, Try again';
  }
}
